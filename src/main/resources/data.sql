...
BEGIN
    INSERT INTO users (username, email, password_hash, full_name, avatar_url, role, is_admin, current_level, total_points, is_active)
    VALUES 
    ('student', 'user@gmail.com', '$2a$10$8.tX9s86n.H5lE8pB8dJbeK6G2wT/P9nC/NpyBwRjUjJ2B53/1BvG', N'Học Viên Mẫu', 'https://api.dicebear.com/7.x/adventurer/svg?seed=student', 'USER', 0, 'BEGINNER', 0, 1),
    ('administrator', 'admin@gmail.com', '$2a$10$8.tX9s86n.H5lE8pB8dJbeK6G2wT/P9nC/NpyBwRjUjJ2B53/1BvG', N'Quản Trị Viên', 'https://api.dicebear.com/7.x/adventurer/svg?seed=admin', 'ADMIN', 1, 'ADVANCED', 0, 1);
END;
