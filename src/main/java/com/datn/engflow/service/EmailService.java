...
public class EmailService {
    ...
    public void sendStreakReminder(String toEmail, String fullName, int currentStreak) {
        ...
        String streakDisplay = currentStreak > 0
                ? "<div style='font-size:64px;font-weight:900;color:#D02020;'>" + currentStreak + "</div><div style='font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#666;'>ngày liên tục</div>"
