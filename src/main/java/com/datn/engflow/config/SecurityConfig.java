    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/vocabulary/search").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/api/vocabulary", "/api/vocabulary/**").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.POST, "/api/exercises/submit").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/exercises/submissions").authenticated()
