...
- Frontend tests: `Set-Location frontend; cmd /c "npx vitest run"` — baseline: **193 passed / 1 skipped (31 files)** (audit-v13 + A1, 2026-09-22). Trước đó: 175 → 172 → 146 → 127 (audit-v12 Phase 11) → 128 (Phase 10) → 121 (Phase 9) → 119 (Phase 0) → 89 (audit-v8).
