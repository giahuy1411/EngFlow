...
OUT = os.path.join(ROOT, ".specify", "specs", "audit-v8-full", "endpoint-map.md")
...
def main():
    ...
    cov_path = os.path.join(ROOT, ".specify", "specs", "audit-v8-full",
    ...
    lines = []
    lines.append("# Endpoint map — audit-v8-full (Round 1)\n")
