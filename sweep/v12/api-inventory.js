/**
 * audit-v12-full T0.7 — endpoint inventory, re-derived from SOURCE (read-only).
 *
 ...
 *
 * Run: node sweep/v12/api-inventory.js
 * Out: .specify/specs/audit-v12-full/evidence/endpoint-inventory.json
 */
const fs = require("fs");
...
const OUT = path.join(ROOT, ".specify", "specs", "audit-v12-full", "evidence", "endpoint-inventory.json");
