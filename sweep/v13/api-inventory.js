/**
 * audit-v13-full T0.7 — endpoint inventory, re-derived from SOURCE (read-only).
 *
 ...
 * Out: .specify/specs/audit-v13-full/evidence/endpoint-inventory.json
 */
const fs = require("fs");
...
const OUT = path.join(ROOT, ".specify", "specs", "audit-v13-full", "evidence", "endpoint-inventory.json");
