<template>
  <div class="listening-skill space-y-8">
    <div v-if="!skillContent" class="bg-white border-4 border-black rounded-xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-10 text-center">
      ...
      <p class="text-gray-500 mt-2">This lesson doesn't have listening exercises.</p>
    </div>

    <div v-else>
      <!-- Video -->
      <div v-if="listeningData.videoHtml" class="bg-white border-4 border-black rounded-xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
