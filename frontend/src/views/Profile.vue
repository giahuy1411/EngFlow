      ...
      <div class="bg-card border-2 border-foreground rounded-md p-8 shadow-pop-xl mb-8 relative overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row items-center gap-8 relative z-10">
          ...
          <div class="flex gap-4">
            <div class="text-center"><p class="font-black text-2xl text-accent">{{ currentStreak }}</p><p class="font-bold text-[10px] uppercase tracking-widest text-muted-foreground">Streak</p></div>
